...
/// Define paths
var srcPaths = {
    app: ['ClientApp/src/app/main.ts', 'ClientApp/src/app/**/*.ts'],
    js: [
        'ClientApp/src/js/**/*.js',
...
var destPaths = {
    ...
    js_ngbootstrap: 'wwwroot/js/@ng-bootstrap/',
...
gulp.task('js', function () {
    ...
    gulp.src(srcPaths.js_ngbootstrap)
        .pipe(gulp.dest(destPaths.js_ngbootstrap));
